...
class _TituloPlayState extends State<TituloPlay> with SingleTickerProviderStateMixin {
  ...
  final asetAudioPlayer = new AssetsAudioPlayer();
  ...
  void open(){
    ...
    asetAudioPlayer.open(
      Audio('assets/Breaking-Benjamin-Far-Away.mp3'),
      );

    asetAudioPlayer.currentPosition.listen((duration) {
      audioPlayerModel.current = duration;
     });

    asetAudioPlayer.current.listen((playingAudio) {
    ...
    return Container(
      child: Column(
        children: <Widget>[
          ...
          Text('${audioPlayerModel.sonTotalDuration}', style: estilo),
